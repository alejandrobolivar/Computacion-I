...
El primero en acertar la nariz de Mickey obtiene un premio, pero sólo el primero. Desarrolle el
diagrama de Flujo de un programa que, dados los datos registrados de un día de en el
...
if cont_cara != 0:
    ...
    print("Promedio de las coordenadas X de los puntos ubicados dentro de la cara: " , promedio)
else:
