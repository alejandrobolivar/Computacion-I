...
OBJETIVO: Desarrollar una aplicación en VB2010, cuya solución implemente subprogramas tipo procedimiento y/o
funciones.
Problema
El departamento de matemáticas pretende corregir un examen online de operaciones con fracciones, que se le va ha
aplicar a un grupo de estudiantes del curso introductorio. Cuando un estudiante realiza la evaluación del tema, se crea
...
aleatoriamente. Además, la evaluación consiste en resolver cinco (5) operaciones, con un puntaje de 4ptos c/u.
Enunciado
...
si a <= b, c es Cero (0) y r es el valor original de A y
si a > b, c es el cociente entero de A/B y R es el residuo entero de a/b
